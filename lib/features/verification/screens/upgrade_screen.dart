...
class _UpgradeScreenState extends State<UpgradeScreen> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Elite Plan Card
                        _buildElitePlanCard(l10n, priceStr),
    ...
    if (productIndex == -1) {
      if (context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(l10n.productNotFound(productId))),
        );
      }
      return;
    }
  ...
  Widget _buildElitePlanCard(AppLocalizations l10n, String price) {
    String durationText = '';
    if (selectedDuration == PlanDuration.monthly) {
      durationText = l10n.perMonth;
    } else if (selectedDuration == PlanDuration.annually) {
      durationText = l10n.perYear;
    } else {
    ...
    return Container(
      ...
      decoration: ShapeDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            const Color(0xFF276EFB).withValues(alpha: 0.15),
